...
<div class="page4">
	...
	<div class="jrkt">
    	<h2><img src="/public/index/images/page6_01.png"></h2>
    </div>
    <div class="partner_con clearfix" id="scroll2">
            ...
            <ul>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><li>
                    <div class="jr-con">
                        ...
                        <div class="jr-img"><img src="/public/Uploads<?php echo ($info["img"]); ?>"></div>
                        <div class="jr-text">
                            <h4><?php echo ($info["title"]); ?></h4>
                            <div><?php echo (mb_substr($info["content"],0,140,'utf-8')); ?></div>
                           <div class="a-more"><a href="/financial/detail/id/<?php echo ($info["id"]); ?>" target="_blank" >more</a></div> 
                        </div>
                    </div>

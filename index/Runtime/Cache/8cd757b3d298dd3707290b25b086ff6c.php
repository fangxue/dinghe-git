...
<div class="page clearfix">
	...
	<div id="focus">
      <div class="slideDiv">
        <ul class="bigImg" >
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><li><a href="#"><img  src="/public/Uploads<?php echo ($info["path"]); ?>"></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
        <ul class="imgNum">

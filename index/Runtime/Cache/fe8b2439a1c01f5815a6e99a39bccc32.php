...
<div class="page4">
	...
	<div class="page-banner-four">
		<img src="/public/index/images/page4_01.png">
	</div>
	...
	<div class="main">
		<ul class="page4-icon">
			<li><a href="<?php echo ($list[4]); ?>" target="_blank"><img src="/public/index/images/page4_02.png"></a></li>
			<li><a href="<?php echo ($list[5]); ?>" target="_blank"><img src="/public/index/images/page4_03.png"></a></li>
			<li><a href="<?php echo ($list[6]); ?>" target="_blank"><img src="/public/index/images/page4_04.png"></a></li>
		</ul>
	</div>
</div>
</body>

...
<div class="page">
	...
	<div class="partner_con clearfix" id="scroll">
		...
		<div class="scrollDiv">
			<ul>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><li><a href="javascript:void(0);"><img src="<?php echo ($info["path"]); ?>" width="130px" height="79px"></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
		</div>

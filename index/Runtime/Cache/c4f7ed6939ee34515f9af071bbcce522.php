...
<div class="page4">
	...
	<div class="tc download-icon"><img src="/assets/images/page5_01.png"></div>
    <div class="download">
    	<div class="partner_con clearfix" id="scroll1">
        <div class="left_but scroll_up"></div>
        <div class="scrollDiv">
            <ul>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><li><a href="javascript:window.open('<?php echo ($info["table_link"]); ?>');"><img src="/assets/images/<?php echo ($info["img_radio"]); ?>"></a>

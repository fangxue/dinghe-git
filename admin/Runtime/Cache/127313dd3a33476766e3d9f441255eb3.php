...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	<h1 class="page-header">资产管理-<?php if($list['id']): ?>编辑文章<?php else: echo ($title); ?>-增加文章<?php endif; ?></h1>
	<a class="btn btn-primary" href="/Property/index">返回分类列表</a>
	<a class="btn btn-primary" href="/Property/articleManage/id/<?php echo ($classid); ?>">返回文章列表</a>

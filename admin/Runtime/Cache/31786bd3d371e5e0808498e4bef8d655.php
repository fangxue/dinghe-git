...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	...
	<a class="btn btn-primary" href="/News/addClass">增加分类</a>
	...
	<table class="table table-hover folder-list" style="margin-top:10px">
		<tbody>
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>   
				...
				<td>
					<a class="btn btn-default btn-xs" href="/News/addClass/id/<?php echo ($info["id"]); ?>">编辑</a>
					<a class="btn btn-default btn-xs" href="/News/del/id/<?php echo ($info["id"]); ?>">删除</a>
					<a class="btn btn-default btn-xs" href="/News/articleManage/id/<?php echo ($info["id"]); ?>">管理文章</a>
				</td>

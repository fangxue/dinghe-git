...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	...
	<a class="btn btn-primary" href="/Download/index">返回列表</a>
	...
	<form class="form-horizontal" role="form"  id="myprofile" enctype="multipart/form-data"  method="POST" style="margin-top:10px">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<table class="table" >
					<tr>
						<td><img src="http://<?php echo ($WebHost); ?>/assets/images/page5_02.png"></td>
						<td><img src="http://<?php echo ($WebHost); ?>/assets/images/page5_03.png"></td>
						<td><img src="http://<?php echo ($WebHost); ?>/assets/images/page5_04.png"></td>
						<td><img src="http://<?php echo ($WebHost); ?>/assets/images/page5_05.png"></td>
						<td><img src="http://<?php echo ($WebHost); ?>/assets/images/page5_06.png"></td>
						<td><img src="http://<?php echo ($WebHost); ?>/assets/images/page5_07.png"></td>
						<td><img src="http://<?php echo ($WebHost); ?>/assets/images/page5_08.png"></td>
					</tr>
					<tr>

...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	<h1 class="page-header">商业保理-<?php echo ($title); ?></h1>
	<a class="btn btn-primary" href="/admin.php/Commerce/index">返回分类列表</a>
	<a class="btn btn-primary" href="/admin.php/Commerce/addArticle/id/<?php echo ($classid); ?>">增加文章</a>
	...
	<table class="table table-hover folder-list" style="margin-top:10px">
		<tbody>
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>   
				<td><?php echo (mb_substr($info["title"],0,60,'utf-8')); ?></td>
				<td><?php echo (date('Y-m-d',$info["create_time"])); ?></td>
				<td>
					<a class="btn btn-default btn-xs" href="/admin.php/Commerce/addArticle/id/<?php echo ($classid); ?>/articleid/<?php echo ($info["id"]); ?>">编辑</a>
					<a class="btn btn-default btn-xs" href="/admin.php/Commerce/delarticle/id/<?php echo ($classid); ?>/articleid/<?php echo ($info["id"]); ?>">删除</a>

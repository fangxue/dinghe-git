...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	...
	<a class="btn btn-primary" href="/Download/addTable">增加表格</a>
	...
	<table class="table table-hover folder-list" style="margin-top:10px">
		<tbody>
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
					<td><img src="http://<?php echo ($WebHost); ?>/assets/images/<?php echo ($info["img_radio"]); ?>" width="30px"></td>
					<td><?php echo (mb_substr($info["name"],0,20,'utf-8')); ?></td>
					<td><?php echo (date('Y-m-d',$info["create_time"])); ?></td>
					<td>
						<a class="btn btn-default btn-xs" href="/Download/addTable/id/<?php echo ($info["id"]); ?>">编辑</a>
						<a class="btn btn-default btn-xs" href="/Download/del/id/<?php echo ($info["id"]); ?>">删除</a>
					</td>

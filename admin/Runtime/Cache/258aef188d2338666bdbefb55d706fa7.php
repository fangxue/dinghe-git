...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><div class="col-sm-2" style="margin-top:8px;">
				<div align="center">
					<img src="/public/Uploads<?php echo ($info["path"]); ?>" class="img-rounded" width="130px" height="79px">
				</div>
				<div align="center" style="margin-top: 5px;"><a href="/admin.php/PartnerLogo/del/id/<?php echo ($info["id"]); ?>">删除</a></div>

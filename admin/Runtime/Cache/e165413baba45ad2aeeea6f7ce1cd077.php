...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	<h1 class="page-header">解決方案<?php if($list['id']): ?>-编辑分类<?php else: ?>-增加分类<?php endif; ?></h1>
	...
	<form class="form-horizontal" role="form"  id="myprofile" enctype="multipart/form-data"  method="POST" style="margin-top:10px">
		...
		<div class="form-group">
			<label for="input-name" class="col-sm-2 control-label">上传封面</label>
			<div class="col-sm-4">
		...
		<?php if(isset($list['img'])): ?><div class="form-group">
			...
			<div class="col-sm-4">
				<img id="show_image"  required="" class="img-thumbnail" src="/public/Uploads<?php echo ($list["img"]); ?>" >
			</div>
		</div><?php endif; ?>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="input-name" class="col-sm-2 control-label">行业借鉴</label>
			<div class="col-sm-8">
				<script id="container" name="reference" type="text/plain" style="min-height:200px;width:100%;"><?php echo ($list["reference"]); ?></script>
				<script type="text/javascript">

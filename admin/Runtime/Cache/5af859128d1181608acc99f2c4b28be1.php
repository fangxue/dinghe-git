...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	<h1 class="page-header">解決方案-<?php echo ($title); if($list['title']): ?>-<?php echo ($list["title"]); endif; ?></h1>
	<a class="btn btn-primary" href="/admin.php/Program/index">返回分类列表</a>
	<a class="btn btn-primary" href="/admin.php/Program/articleManage/id/<?php echo ($classid); ?>">返回文章列表</a>

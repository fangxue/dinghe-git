...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	<h1 class="page-header">商业保理-<?php if($list['id']): ?>编辑文章<?php else: echo ($title); ?>-增加文章<?php endif; ?></h1>
	<a class="btn btn-primary" href="/admin.php/Commerce/index">返回分类列表</a>
	<a class="btn btn-primary" href="/admin.php/Commerce/articleManage/id/<?php echo ($classid); ?>">返回文章列表</a>

	<form class="form-horizontal" role="form"  id="myprofile"  method="POST" style="margin-top:10px">
